...
<span class="inline-flex items-center gap-1.5 rounded-full bg-primary-50 border border-primary-200 px-4 py-2 text-primary-700 font-bold text-lg rtl:flex-row-reverse" role="status">
