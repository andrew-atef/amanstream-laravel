...
<div class="inline-flex items-center gap-2 rounded-xl bg-primary-50 border border-primary-200 px-4 py-2" role="status">
    <div class="flex flex-row-reverse" title="{{ $rating }}">
        @for ($i = 1; $i <= 5; $i++)
            ...
            @else
                <svg class="w-5 h-5 text-mist" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2l2.9 6.3 6.9.9-5 4.8 1.2 6.9-6-3.2-6 3.2 1.2-6.9-5-4.8 6.9-.9L12 2z"/></svg>
            @endif
        @endfor
    </div>
