...
<div class="my-6 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
    <div class="border-b border-slate-100 bg-slate-50 flex items-center gap-2 px-4 py-3 sm:px-6 sm:py-3.5">
        ...
        <h3 class="min-w-0 flex-1 text-base font-bold leading-tight text-ink">ملخص سريع: {{ $product?->title }}</h3>
    </div>
    <div class="grid grid-cols-1 divide-y divide-slate-200 md:grid-cols-2 md:divide-x md:divide-y-0 rtl:divide-x-reverse">
        <div class="p-5">
            <h4 class="mb-3 flex items-center gap-2 font-bold text-primary-700">المميزات الرئيسية</h4>
            <ul class="space-y-2.5 text-sm leading-7 text-ink/80">
        ...
        <div class="p-5">
            <h4 class="mb-3 flex items-center gap-2 font-bold text-ink">ملاحظات قبل الشراء</h4>
            <ul class="space-y-2.5 text-sm leading-7 text-ink/80">
