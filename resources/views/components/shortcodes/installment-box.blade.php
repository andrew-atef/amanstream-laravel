...
<div class="my-6 rounded-2xl border border-primary-200 bg-gradient-to-br from-primary-50 to-primary-50 p-6">
    <div class="flex items-center gap-3 mb-4">
        <span class="grid place-items-center w-10 h-10 rounded-full bg-primary-600 text-white shadow-sm">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5z"/></svg>
        </span>
        <div>
            <h3 class="font-bold text-primary-900 text-lg">قسّط سعر الجهاز على 12 شهر</h3>
            <p class="text-primary-700 text-sm">دفعة شهرية تقريبية بدون فوائد عبر البنوك المصرية</p>
        </div>
    </div>
