<footer class="mt-20 border-t border-slate-200 bg-white py-10 text-center text-xs text-ink/70">
    <div class="mx-auto max-w-6xl px-4">
        ...
        <p>© {{ date('Y') }} {{ config('app.name', 'أمان برايس') }} — جميع الحقوق محفوظة.</p>
        <p class="mx-auto mt-2 max-w-md text-[11px] text-slate-500">
            موقع {{ config('app.name', 'أمان برايس') }} يقدم مراجعات ومقارنات أسعار محايدة. قد نتحصل على عمولة تسويقية عند الشراء من خلال روابط أمازون دون أي زيادة في السعر عليك.
        </p>
    </div>
</footer>